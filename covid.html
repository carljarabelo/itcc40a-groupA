	...
	<section>
		...
		<div id="mySidenav" class="sidenav">
			...
			<div class="dropdown">
				...
				<a href="applicant2.html">Upperclassmen Online Admissions & Enrolment Process for Returnees and 2nd Courser Applicants</a>
...
<Article>
 <div id="maincontainer"> 
	<div id="main">
		...
		<img src="XUKontraCOVID19_3.jpg" alt="" style="width:100%;">
		<div class="header">
...
This page contains information, updates and announcements on the current engagements of the #XUKontraCOVID19 Response as well as important developments on the COVID 19 Pandemic.
					...
					<p><h2> Community Guidance </h2>
                        President’s Memoranda on the #XUKontraCOVID19 Response as well as information, updates and announcements from the Office of the President on Xavier Ateneo’s Institutional Engagements relevant to the COVID 19 Pandemic</p> </div>
		
					<p>
                        <br>
                        <H2>News and Info graphics</H2>
                    ...
                    <br>
                    <p>
                        <h2>#XUKontraCOVID19 Bulletins and Briefer</h2>
	...
	<div class="container">
		<div class="col-span-2">
			<div>
				...
				<p style="color:gray ;">
				   Developed by Kids "Michael Mari Angelo Laguardia"
				</p>
			</div>
		</div>
		<div class="row">
